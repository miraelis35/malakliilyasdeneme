...
exports.run = (client, message, args) => {
    var ilgincsöz = [
      ...
      "Japonyada garsonlar yüksek maaş aldıkları için bahşiş verilmesi aşağılamak olarak görünür",
      "Fransada güzel bir şarabın yanında peynir tüketilir",
      "35 yaşında olan bir Trabzonlu hiç sampiyonluk görememiştir.",
