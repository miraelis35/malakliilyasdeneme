...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "bot") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**ne var amk**");
    } else {
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "link") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**bu ne terbiyesizliktir daha link paylasilmamis orospucocuklari**");
    } else {
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "face") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**Bot yapımcısı facebook hesabı - Ertaç Keser**");
    } else {
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "bot davet") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("**https://discord.com/oauth2/authorize?client_id=776658480982786099&scope=bot&permissions=2146958719**");
    } else {
      msg.reply("**https://discord.com/oauth2/authorize?client_id=776658480982786099&scope=bot&permissions=2146958719**");
    }
  }
});
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "insta") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.author.sendMessage("** ertackeser **");
    } else {
